...
const Videos = () => {
  ...
  return (
    <>
      <div className=" items-start mt-1 justify-start flex md:flex-row flex-col ">
        <div className="flex w-full md:w-[75vw] relative top-0 left-0   flex-row flex-wrap ">
           
            <video className="mt-0 flex w-full md:w-[75vw]"width={"100%"}  src={videosrc} controls muted></video>{" "}
          
          <span className="p-3 ">
            <h2 className="text-2xl font-semibold text-black">Learn with us </h2>
            <p>
              Lorem ipsum, dolor sit amet consectetur adipisicing elit.
              Voluptates harum, maiores in cum officiis, atque reiciendis
              voluptatem veniam nobis non eaque sequi laboriosam quisquam quis,
              corrupti tempora soluta hic. Vero!
              Voluptates harum, maiores in cum officiis, atque reiciendis
              voluptatem veniam nobis non eaque sequi laboriosam quisquam quis,
              corrupti tempora soluta hic. Vero!
            </p>
        ...
        <div className="  overflow-x-hidden flex  items-center w-full   md:w-[25vw] flex-col">

          
      {vidarr.map((item, index) => (
               <button key={index+1}
               className="p-2  mb-2 font-medium bg-slate-50 border-2 text-center w-full"
